...
const Navbar = () => {
    ...
    return (
        <div className='w-screen h-[80px] z-10 bg-[#653818] fixed drop-shadow-lg'>
            <div className='px-2 flex justify-between items-center w-full h-full'>
                <div className='flex items-center text-[#ede0d4]'>
                    <Link to="home" smooth={true} duration={500}><img src={newLogo} alt="Law Scholar's Logo" className="h-20 mr-4 ml-4 cursor-pointer" /></Link>
