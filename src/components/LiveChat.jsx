...
const LiveChat = () => {
    return (
        <div name='livechat' className='w-full pt-10'>
            <div className='max-w-[1240px] mx-auto my-8'>
            <div className='text-center'>
                    <h2 className='text-5xl font-bold'>Live Discussion</h2>
                </div>
                    ...
                    <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
                        <div class="relative flex items-center space-x-4">
                            <div class="relative">
                                ...
                                <img src="https://source.unsplash.com/random/?portrait" alt="" class="w-10 sm:w-16 h-10 sm:h-16 rounded-full" />
                            </div>
                            <div class="flex flex-col leading-tight">
                                <div class="text-2xl mt-1 flex items-center">
                                    <span class="text-gray-700 mr-3">Erlick Bockman</span>
                                </div>
                                <span class="text-lg text-gray-600">Lawyer</span>
                            </div>
                        </div>
