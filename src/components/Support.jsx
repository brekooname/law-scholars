...
const Support = () => {
    return (
        <div name='support' className='w-full mt-36'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
                    <div className='bg-white rounded-xl shadow-2xl'>
                        ...
                        <div className='bg-slate-100 pl-8 py-4'>
                            <p className='flex items-center text-blue-500 cursor-pointer'>Contact Us <FontAwesomeIcon icon={faArrowRight} className='w-5 ml-2' /></p>
                        </div>
                    </div>
                    <div className='bg-white rounded-xl shadow-2xl'>
                        <div className='p-8'>
                            <FontAwesomeIcon className="w-4 p-4 bg-blue-500 text-white rounded-lg mt-[-1rem]" icon={faGlobe} />
                    ...
                    <div className='bg-white rounded-xl shadow-2xl'>
                        <div className='p-8'>
                            <FontAwesomeIcon icon={faMicrochip} className='w-4 p-4 bg-blue-500 text-white rounded-lg mt-[-1rem]' />
