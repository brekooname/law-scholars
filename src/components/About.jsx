        ...
        <div name='about' className='w-full my-32'>
            <div className='max-w-[1240px] mx-auto'>
                <div className='text-center'>
                    ...
                    <p className='text-3xl text-gray-500 py-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum placeat assumenda nostrum sed, voluptatem nesciunt sit fuga illo totam provident non a, quam nihil est.</p>
                </div>

                <div className='grid md:grid-cols-3 gap-6 px-4 text-center py-20'>
